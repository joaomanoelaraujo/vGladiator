...
public class Lobby {
  ...
  public static final KConfig CONFIG = JavaGlad.getInstance().getConfig("lobbies");
  ...
  public static void setupLobbies() {
    ...
    if (!query.isEmpty()) {
      ...
      }.runTaskTimerAsynchronously(JavaGlad.getInstance(), 0, 40);
    }
  }
  ...
  public int getPlayers() {
    return this.serverName.equals(JavaGlad.currentServerName) ? Bukkit.getOnlinePlayers().size() : ServerItem.getServerCount(this.serverName);
  }
