package br.com.johnmanoel.d4rkk.glad.listeners.entity;
...
public class EntityListener implements Listener {
  ...
  public void onEntityDamageByEntity(EntityDamageByEntityEvent evt) {
    ...
    if (evt.getEntity() instanceof Player) {
      ...
      if (profile == null || (game = profile.getGame(Gladiator.class)) == null || game.getState() != GameState.EMJOGO || game.isSpectator(player)) {
          ...
          if (proj.getShooter() instanceof Player) {
            ...
            if (profile2 == null || profile2.getGame() == null || !profile2.getGame().equals(game) || game.isSpectator(damager) || damager.equals(player) || (team != null && team
              ...
              if (proj instanceof Arrow) {
                ...
                Bukkit.getScheduler().scheduleSyncDelayedTask(JavaGlad.getInstance(), () -> finalDamager
